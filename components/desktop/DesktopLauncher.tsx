...
export default function DesktopLauncher() {
  ...
  return (
    <section
      aria-label="Apps"
      className="pointer-events-auto mx-auto flex h-full max-w-[1120px] flex-col px-6 pb-10 pt-6"
    >
      <div className="mb-2 flex justify-center">
        <div className="chrisos-launcher-chip rounded-full border border-white/[0.05] bg-white/[0.03] px-4 py-1.5 text-[11px] text-zinc-300 shadow-[0_14px_40px_rgba(0,0,0,0.75)] backdrop-blur-2xl">
          Launch an app to get started
        </div>
      </div>
      <div className="chrisos-launcher-panel rounded-3xl border border-white/[0.05] bg-white/[0.02] p-5 shadow-[0_24px_70px_rgba(0,0,0,0.8)] backdrop-blur-3xl">
