...
export default function MobileSystemBar() {
  ...
  return (
    <div className="pointer-events-none flex items-center justify-center px-4 pb-3 pt-2 sm:pb-4">
      <div className="flex w-full max-w-xl items-center justify-between rounded-2xl border border-white/[0.05] bg-[var(--menu-bar)]/80 px-3 py-2 text-[11px] text-zinc-400 shadow-[0_12px_35px_rgba(0,0,0,0.7)] backdrop-blur-2xl">
